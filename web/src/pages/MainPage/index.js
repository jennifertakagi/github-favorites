  ...
  return (
    <div id="main-page">
      ...
      <div className="search-area">
        <Input id="userInput" name="userInput" placeholder="Who's the user?" type="text" value={user} onChange={(e) => handleInputChange(e.target.value)}/>
...
{errorMessage && <p className="error-message">{errorMessage}</p>}
      ...
      {repositories && (<ul id="repository-list">
